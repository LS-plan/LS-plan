<!--
  GitHub Profile README for LS-plan
  仓库路径: github.com/LS-plan/LS-plan
  风格: 中文为主、克制专业，混合型博士主页
-->

# Hi, I'm ShuyuS 👋

**博士在读 @ BUPT · AI Agent / AI Tools / AI4S**
...
* 🎓 北京邮电大学（BUPT）博士在读，研究兴趣偏向 **AI Agent / AI4S / 科研工具链**
* 🔭 当前重点：智能体工作流编排、AI CLI 工具、面向科研的自动化与可复现实践
* ⚙️ 工程偏好：TypeScript / Python / Rust，命令行优先，文档与脚本并重
* 📡 背景沉淀：通信与电子工程，对信号、嵌入式、网络协议保有持续兴趣
...
| 方向 | 关注点 |
| --- | --- |
| **AI Agent** | 多智能体协作、工具调用、长任务记忆与规划 |
| **AI Tools** | 终端工具链、CLI Wrapper、Token 优化、Prompt 工程 |
| **AI4S** | 科研写作辅助、实验自动化、文献检索与综述 |
| **通信电子** | 信号处理、电子系统设计中的 AI 增强方法 |
...
> 更多历史项目（本科/学习记录）保留在 [全部仓库](https://github.com/LS-plan?tab=repositories)，不在主页核心展示。

---

## 🛠️ 技术栈

[![Skills](https://skillicons.dev/icons?i=python,ts,js,rust,html,css,react,nextjs,nodejs,git,github,linux,vscode,latex,md\&perline=8)](https://skillicons.dev)
...
<p align="center">
  <img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=LS-plan&layout=compact&hide_border=true&langs_count=8&theme=tokyonight" alt="Top Languages" />
</p>
